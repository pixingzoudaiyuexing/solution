...
Phase 2Q 以向后兼容的 additive extension 新增 Advance Subscription Period，当前真实 source route tree 包含 38 个 `/api/v1` Public routes。已有 v1 Contract baseline 保持冻结；完整 METHOD、PATH、DTO、错误与分页契约以 `docs/API-CONTRACT.md` 为 SSOT。
